export const PAINTS: {
  ...
  { id: 14, class: "gold", name: "Gold" },
  { id: 15, class: "rosegold", name: "Rose Gold" },
  { id: 16, class: "whitegold", name: "White Gold" },
  { id: 17, class: "onyx", name: "Onyx" },
  { id: 18, class: "platinum", name: "Platinum" },
];
